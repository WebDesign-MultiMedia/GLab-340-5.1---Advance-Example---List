...
# Defines a function named "record_profit_years" that take two paramerers 
...
# Assign the two lists to the two variables to be passed to the recrod_profit_years() function.
